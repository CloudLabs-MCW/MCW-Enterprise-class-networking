...
1. On the **WGWEB1** blade, under **Networking (1)** then choose **Application security groups (2)** and click on **+ Add application security groups (3)**, select **WebTier (4)**, and click **Add (5)**.
