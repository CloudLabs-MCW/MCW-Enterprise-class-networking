...
1. In the Firewall's overview blade, select **Public IP Configuration(1)**, then copy the **public IP address(2)** of the firewall.
...
1. Click on **Use a different account(1)**.
