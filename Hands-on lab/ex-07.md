...
1. On the **Create a firewall** blade, on the **Basics** tab, enter the following information:
    ...
    | Name | **azureFirewall** **(2)** |
    | Region | **South Central US** **(3)**|
    | Firewall SKU | **Standard** **(4)** |
    | Firewall management | **Use Firewall rules (classic) to manage this Firewall** **(5)** |
    | Choose a Virtual network | **Use existing** **(6)** |

    ![](images/firewallnew.png)
