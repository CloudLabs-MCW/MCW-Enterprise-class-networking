...
In this task you will, create a Virtual Network Gateway enables secure cross-premises and site-to-site connectivity by routing encrypted traffic between your on-premise network and Azure virtual networks.
...
1. On the **Hybrid Connectivity** page, In the left pane select the **VPN Gateway (1)** and then choose **VPN Gateways (2)** from the drop down.

    ![](images/ecn_g_e2_2.png)

1. On the **VPN gateways** pane, select **VPN gateways (1)** from the left navigation menu. Click the **+ Create (2)** button at the top.
