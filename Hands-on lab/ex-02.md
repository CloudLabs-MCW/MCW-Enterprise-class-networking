...
After creating the foundational Azure networking environment, the Woodgrove Financial Services networking team must enable secure communication between the on-premises datacenter and Azure. To support hybrid operations and secure traffic flow, VPN gateways must be deployed in both environments.

In this exercise, you will configure virtual network gateways that will later be used to establish secure site-to-site communication across the enterprise environment.

## 📖 Overview

In this exercise, you will configure VPN gateways to establish secure hybrid connectivity between the simulated on-premises environment and Azure virtual networks. 
...
In this lab, you have performed the foundational steps to set up secure connectivity between the on-premises environment and Azure.
