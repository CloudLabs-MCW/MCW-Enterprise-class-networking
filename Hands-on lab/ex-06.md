...
1. Within WGWEB1, open **Microsoft Edge** from the Start menu and navigate to <http://10.8.0.100>. Ensure that you successfully connect to either one of the two Web servers.
   ...
   >**Note:**  If the web page fails to load and displays an error, check whether 120.0.0.1 is accessible from the browser. If it is not reachable, reboot both servers and try accessing the page again.
