...
1. Select the **Load balancers (1)** from the left blade, click on **+ Create (2)** and then choose **Standard Load balancer**.

    ![](images/loadbalancernew1.png)
...
1. On the **Create load balancer** blade, on the **Basics** tab, enter the following values:
    ...
    Ensure your **Create load balancer** dialog looks like the following, and select **Next: Frontend IP configuration (7)** then select **Create**.
