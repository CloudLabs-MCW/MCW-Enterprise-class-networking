...
1. Set the following configuration for the new peering. Select **Add** to create the peering.
    ...
    **Remote virtual network summary**
    ...
    | **Subscription** | **Defualt Subscription (2)** |
...
1. On the **Hybrid Connectivity** blade, expand **VPN gateways** and then choose the **VPN Connections (1)** from drop down and click on **+ Create (2)**.
...
1. On the Settings tab specify the following: then click on **Review + create** Tab 
