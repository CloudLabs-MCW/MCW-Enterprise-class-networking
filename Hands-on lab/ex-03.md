...
1. On the configuration blade for **WGVNet1**. Select **Peerings (1)** under **Settings** on the left then select **+ Add (2)**.
    ...
    ![In this screenshot, the Peerings blade of the WGVNet1 Virtual Network resources is depicted. With the '+ Add' button selected.](images/hol-ex2-task1-add-peerings-buttonupd.png "Virtual network blade")
