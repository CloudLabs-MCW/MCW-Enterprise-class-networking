...
10. Repeat Steps 6 - 9 to create a flow log for the **OnPremVM-nsg** Network Security Group as well. Onece the deployemnet is completd, click on **Go to resources**. When completed your **NSG flow logs** blade on **Network Watcher** should look like what's depicted in the below image.
