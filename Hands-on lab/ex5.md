...
1. Select **Backend pools**, and select **+Add** at the beginning.
...
1. Under **Virtual machine**, choose the **WGWEB1** and **WGWEB2** virtual machines and select **Add**.
...
1. Next, under **Settings** on the **WGWEBLB** Load Balancer blade, select **Health Probes**. Select **+ Add**:
